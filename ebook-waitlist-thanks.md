...
permalink: /ebook-waitlist-thanks/
---
...
<section class="sec" style="min-height:70vh;display:flex;align-items:center;justify-content:center;">
  <div style="max-width:600px;width:100%;background:rgba(244,241,235,0.04);border:1px solid rgba(244,241,235,0.15);border-top:2px solid #D4A843;padding:32px;">
    ...
    <div style="margin-top:16px;border-top:1px dashed var(--border);padding-top:14px;font-family:var(--serif);font-size:18px;color:var(--white);line-height:1.8;">
      ...
      <div>② The Hardware Guide <span style="float:right;font-family:var(--mono);color:var(--grey);font-size:12px;">$5.99</span></div>
      <div>③ The Open Source Student (Standalone) <span style="float:right;font-family:var(--mono);color:var(--grey);font-size:12px;">$9.99</span></div>
      <div>④ Operational Guide <span style="float:right;font-family:var(--mono);color:var(--grey);font-size:12px;">$5.99</span></div>
      <div>⑤ Student Setup Checklist <span style="float:right;font-family:var(--mono);color:var(--grey);font-size:12px;">$4.99</span></div>
      <div>⑥ The Terminal Survival Guide <span style="float:right;font-family:var(--mono);color:var(--grey);font-size:12px;">$9.99</span></div>
    </div>

    <div style="margin-top:14px;border-top:1px dashed var(--border);padding-top:10px;display:flex;justify-content:space-between;font-family:var(--mono);font-size:12px;color:var(--grey);">
      <span>Individual total: $41.94</span>
      <span style="color:var(--amber);">Your price: $9.99</span>
    </div>
